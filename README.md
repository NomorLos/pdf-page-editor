...
- PPT 转 PDF 并进入编辑区，之后可刷新为 `不合并`、`2合1`、`4合1`、`6合1`、`8合1`
...
- 导入完成后，可在侧边栏选择 `不合并`、`2合1`、`4合1`、`6合1`、`8合1`，再点击 `刷新已生成格式`。刷新后编辑区缩略图会同步更新，后续仍可重排、删除、旋转、拆分、导出。
- `PPT转PDF保存`：选择 PPT 多页合一方式后，再选择 `.ppt` 或 `.pptx`，只转换并保存 PDF。
